...
class Ui_mw_MainWindow(object):
    ...
    def retranslateUi(self, mw_MainWindow):
        ...
        self.a_NewTask.setText(QCoreApplication.translate("mw_MainWindow", u"View Tasks", None))
        self.m_Tasks.setTitle(QCoreApplication.translate("mw_MainWindow", u"Task Manager", None))
