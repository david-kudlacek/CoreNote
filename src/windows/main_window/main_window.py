...
class Ui_mw_MainWindow(object):
    def setupUi(self, mw_MainWindow):
        ...
        self.a_ViewTasks = QAction(mw_MainWindow)
        self.a_ViewTasks.setObjectName(u"a_ViewTasks")
        self.a_NewTask = QAction(mw_MainWindow)
        self.a_NewTask.setObjectName(u"a_NewTask")
        ...
        self.m_Tasks.addAction(self.a_ViewTasks)
        self.m_Tasks.addAction(self.a_NewTask)
    ...
    def retranslateUi(self, mw_MainWindow):
        ...
        self.a_ViewTasks.setText(QCoreApplication.translate("mw_MainWindow", u"View Tasks", None))
        self.a_NewTask.setText(QCoreApplication.translate("mw_MainWindow", u"New Task", None))
